...
if(action==='inspect_import' && req.method==='POST'){
    ...
    if(filtroId>0){
      ...
      const approved=[];
      // Mantém a avaliação oficial jogo a jogo, mas usa concorrência maior e
      // ainda controlada. O resultado continua vindo da mesma função oficial;
      // só reduzimos o número de ondas HTTP necessárias.
      const chunkSize=100;
