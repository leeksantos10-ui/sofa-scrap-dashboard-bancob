...
if(action==='inspect_import' && req.method==='POST'){
    ...
    if(filtroId>0){
      ...
      const approved=[];
      // Mantém a avaliação oficial jogo a jogo, mas aumenta a concorrência
      // controlada para reduzir o tempo total sem disparar centenas de requisições
      // simultâneas contra o Supabase.
      const chunkSize=50;
